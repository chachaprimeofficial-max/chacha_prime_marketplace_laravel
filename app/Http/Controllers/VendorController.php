...
class VendorController extends Controller
{
 ...
 public function storeProduct(Request $request){
  $vendor=$this->vendor($request);
  $d=$request->validate(['name'=>'required|string|max:220','category_id'=>'nullable|exists:categories,id','brand_id'=>'nullable|exists:brands,id','short_description'=>'nullable|string|max:1000','description'=>'nullable|string','highlights'=>'nullable|string|max:10000','specifications'=>'nullable|string|max:15000','shipping_info'=>'nullable|string|max:5000','features'=>'nullable|string|max:10000','additional_details'=>'nullable|string|max:10000','return_policy'=>'nullable|string|max:500','video_urls'=>'nullable|string|max:10000','retail_price'=>'required|numeric|min:0','wholesale_price'=>'nullable|numeric|min:0','factory_price'=>'nullable|numeric|min:0','cost_price'=>'nullable|numeric|min:0','currency'=>'required|string|size:3','stock'=>'required|numeric|min:0','sku'=>'nullable|string|max:100','images'=>'nullable|array|max:8','images.*'=>'image|mimes:jpg,jpeg,png,webp|max:4096','videos'=>'nullable|array|max:4','videos.*'=>'file|mimes:mp4,webm,mov|max:51200']);

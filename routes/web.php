...
use App\Http\Controllers\CountryMarketplaceController;
use App\Http\Controllers\AdminSupportController;
use Illuminate\Support\Facades\Route;
Route::get('/',[StorefrontController::class,'home'])->name('home');
Route::get('/marketplace/country',[CountryMarketplaceController::class,'index'])->name('marketplace.country.selector');
Route::post('/marketplace/country',[CountryMarketplaceController::class,'select'])->name('marketplace.country.select');
